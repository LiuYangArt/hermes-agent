...
def main():
    ...
    parser.add_argument("--lingo-chat", action="append", default=[])
    ...
    config["team_governance"] = {
        "enabled": True,
        "app_id": app_id,
        "lingo": {"repo_ids": args.lingo_repo, "allowed_chat_ids": args.lingo_chat},
    }
    ...
    print(json.dumps({"configured": True, "administrators": len(args.admin), "glossaries": len(args.lingo_repo), "authorized_chats": len(args.lingo_chat), "restart_required": True}))
